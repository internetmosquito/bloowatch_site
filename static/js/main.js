...
var App = { init: function() {
  ...
  Elements_animation: function() {
          ...
          setTimeout(function(){$('.content_anim8').addClass('animated fadeInUp')},600);
      }, { offset: '50%' });
      ...
      $('#offers').waypoint(function() {
          ...
          setTimeout(function(){$('.content_anim17').addClass('animated fadeInUp')},1600);
          setTimeout(function(){$('.content_anim18').addClass('animated fadeInUp')},1800);
          setTimeout(function(){$('.content_anim19').addClass('animated fadeInUp')},2000);
      }, { offset: '50%' });

      $('#reviews').waypoint(function() {
          setTimeout(function(){$('.content_anim20').addClass('animated fadeInUp')},0);
      }, { offset: '50%' });

      $('#customersID').waypoint(function() {
          setTimeout(function(){$('.content_anim21').addClass('animated fadeInUp')},0);
          setTimeout(function(){$('.content_anim22').addClass('animated fadeInUp')},200);
          setTimeout(function(){$('.content_anim23').addClass('animated fadeInUp')},400);
          setTimeout(function(){$('.content_anim24').addClass('animated fadeInUp')},600);
          setTimeout(function(){$('.content_anim25').addClass('animated fadeInUp')},800);
          setTimeout(function(){$('.content_anim26').addClass('animated fadeInUp')},1000);
      }, { offset: '50%' });
